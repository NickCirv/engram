...
**Strategic basis:** internal strategy roadmap (private)
**Decision basis:** internal decision log — single-release-vs-staircase (private)
...
These are all in the internal decision log (single-release-vs-staircase) under "Trade-offs accepted."
