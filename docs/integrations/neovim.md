...
Engram does not ship a Neovim plugin. Use a terminal command first; any MCP bridge or AI plugin must be installed and configured separately for its own version.
